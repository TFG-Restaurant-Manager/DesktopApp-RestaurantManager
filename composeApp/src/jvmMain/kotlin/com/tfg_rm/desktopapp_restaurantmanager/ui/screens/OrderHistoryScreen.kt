...
fun OrderHistoryScreen(viewModel: OrderHistoryViewModel, modifier: Modifier = Modifier) {
    ...
    Column(modifier = modifier.fillMaxSize().padding(horizontal = 32.dp, vertical = 24.dp)) {
        ...
        Row(
            ...
            HistoryStatCard(Modifier.weight(1f), Strings.t("screen.orderHistory.stat.total"),   orders.size.toString())
            HistoryStatCard(Modifier.weight(1f), Strings.t("screen.orderHistory.stat.today"),   todayOrders.toString(), Color(0xFF1565C0))
            HistoryStatCard(Modifier.weight(1f), Strings.t("screen.orderHistory.stat.revenue"), "%.2f €".format(totalRevenue), Color(0xFF2E7D32))
        }
        ...
        Surface(
            ...
            Column {
                ...
                Row(
                    ...
                    Text("#",                                               Modifier.width(48.dp),  fontWeight = FontWeight.SemiBold, style = MaterialTheme.typography.labelLarge)
                    Text(Strings.t("screen.orderHistory.col.table"),       Modifier.width(80.dp),  fontWeight = FontWeight.SemiBold, style = MaterialTheme.typography.labelLarge)
                    Text(Strings.t("screen.orderHistory.col.items"),       Modifier.weight(1f),    fontWeight = FontWeight.SemiBold, style = MaterialTheme.typography.labelLarge)
                    Text(Strings.t("screen.orderHistory.col.total"),       Modifier.width(90.dp),  fontWeight = FontWeight.SemiBold, style = MaterialTheme.typography.labelLarge)
                    Text(Strings.t("screen.orderHistory.col.status"),      Modifier.width(110.dp), fontWeight = FontWeight.SemiBold, style = MaterialTheme.typography.labelLarge)
                    Text(Strings.t("screen.orderHistory.col.date"),        Modifier.width(140.dp), fontWeight = FontWeight.SemiBold, style = MaterialTheme.typography.labelLarge)
                }
                HorizontalDivider()
